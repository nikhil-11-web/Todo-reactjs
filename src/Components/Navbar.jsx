  ...
  return (
    <nav className='sticky top-0 z-50 bg-gradient-to-r from-violet-950 via-slate-900 to-slate-950 text-white shadow-lg shadow-violet-500/20'>
        <div className='max-w-7xl mx-auto px-6 py-4 flex justify-between items-center'>
            ...
            <div className='logo flex items-center gap-4 cursor-pointer group'>
            ...
            <ul className='hidden md:flex gap-10 font-medium text-sm tracking-wider uppercase'>
                <li className='cursor-pointer hover:text-violet-400 transition-all duration-300 relative group'>
                    Home
        ...
        {isMenuOpen && (
            <div className='md:hidden bg-slate-900/95 backdrop-blur-sm border-t border-slate-800 absolute w-full left-0'>
                <ul className='flex flex-col gap-6 py-6 items-center font-medium'>
                    <li className='cursor-pointer hover:text-violet-400 transition-colors' onClick={() => setIsMenuOpen(false)}>
                        Home
                    </li>
                    <li className='cursor-pointer hover:text-violet-400 transition-colors' onClick={() => setIsMenuOpen(false)}>
                        Your Tasks
